<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<style>
		...
		.top-brand .navbar-default {
			...
			border-style: solid;
			border-color: rgba(0,0,0,.3);
			background-color: rgba(157, 77, 51, 1);
			box-shadow: 0 0 6px rgba(30, 144, 255, 0);
		...
		.top-brand .nav .fullscreen {
			...
			border-style: solid;
			border-color: rgba(0,0,0,.3);
			background-color: rgba(194, 168, 161, 1);
		...
		.top-brand .nav .dropdown-menu.profile::before {
			left: 100%;
			margin-left: -28px;
			border-bottom-color: rgba(194, 168, 161, 1);
		}
		...
		.top-brand .nav .dropdown-menu.profile h5 {
			...
			border-width: 0;
			border-style: solid;
			border-color: rgba(194, 168, 161, 1);
			background-color: rgba(194, 168, 161, 1);
			box-shadow: 0 0 6px rgba(30, 144, 255, 0);
			text-align: center;
		}
				...
				<div class="container top-brand" style="display: flex;">
					...
					<nav class="navbar navbar-default">			
						<div class="navbar-header">
							<a href="${pageContext.request.contextPath}/index.jsp">图书借阅系统</a>
						</div>
