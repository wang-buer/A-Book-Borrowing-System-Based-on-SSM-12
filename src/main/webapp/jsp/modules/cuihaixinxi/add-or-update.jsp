		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑催还信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>催还信息管理</span></li>
								<li class="breadcrumb-item active"><span>编辑催还信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">催还信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>催还内容</label>
										<textarea  name="cuihaineirong" class="form-control" id="cuihaineirong" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>日期</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "cuihaixinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("cuihaixinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("cuihaixinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("cuihaixinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#cuihaineirong").val(ruleForm.cuihaineirong);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.cuihaineirong != null && res.data.cuihaineirong != ''){

						$("#cuihaineirong").val(res.data.cuihaineirong);
					}
