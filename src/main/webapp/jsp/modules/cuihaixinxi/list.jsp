...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">催还信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>催还信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">催还信息列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var cuihaineirongCell  = document.createElement('td');

						  if(item.cuihaineirong != null && item.cuihaineirong != "" && item.cuihaineirong.length >= 11){
			  	cuihaineirongCell.innerHTML = item.cuihaineirong.substring(0, 10) + "..."; 
			  }else{
			  	cuihaineirongCell.innerHTML = item.cuihaineirong;
			  }


			row.appendChild(cuihaineirongCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("cuihaixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"cuihaixinxi");
