...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">归还信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>归还信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">归还信息列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('jieshutianshu')">借书天数<i id="jieshutianshuIcon" class="fa fa-sort"></i></th>
											<th>归还备注</th>
											<th onclick="sort('haishuriqi')">还书日期<i id="haishuriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var jieshutianshuCell  = document.createElement('td');

						 jieshutianshuCell.innerHTML = item.jieshutianshu;

			row.appendChild(jieshutianshuCell);
			var guihaibeizhuCell  = document.createElement('td');

						  if(item.guihaibeizhu != null && item.guihaibeizhu != "" && item.guihaibeizhu.length >= 11){
			  	guihaibeizhuCell.innerHTML = item.guihaibeizhu.substring(0, 10) + "..."; 
			  }else{
			  	guihaibeizhuCell.innerHTML = item.guihaibeizhu;
			  }


			row.appendChild(guihaibeizhuCell);
			var haishuriqiCell  = document.createElement('td');

						  haishuriqiCell.innerHTML = item.haishuriqi;


			row.appendChild(haishuriqiCell);
		...
		function sh(){
			...
			httpJson("guihaixinxi/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("guihaixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"guihaixinxi");
