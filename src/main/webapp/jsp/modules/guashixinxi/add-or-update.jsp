...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑挂失信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑挂失信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">挂失信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>挂失内容</label>
										<textarea  name="guashineirong" class="form-control" id="guashineirong" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>申请日期</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "guashixinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("guashixinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("guashixinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function dataBind(){
			...
			$("#guashineirong").val(ruleForm.guashineirong);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.guashineirong != null && res.data.guashineirong != ''){

						$("#guashineirong").val(res.data.guashineirong);
					}
