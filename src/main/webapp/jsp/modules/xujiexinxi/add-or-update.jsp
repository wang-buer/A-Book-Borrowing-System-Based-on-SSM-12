		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑续借信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>续借信息管理</span></li>
								<li class="breadcrumb-item active"><span>编辑续借信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">续借信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>续借天数</label>
										<input name="xujietianshu" id="xujietianshu" name="xujietianshu" class="form-control" placeholder="续借天数">
									</div>
									<div class="form-group col-md-6">
										<label>续借备注</label>
										<textarea  name="xujiebeizhu" class="form-control" id="xujiebeizhu" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>日期</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "xujiexinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("xujiexinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("xujiexinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("xujiexinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#xujiebeizhu").val(ruleForm.xujiebeizhu);
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.xujietianshu != null && res.data.xujietianshu != ''){
						...
						$("#xujietianshu").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.xujiebeizhu != null && res.data.xujiebeizhu != ''){

						$("#xujiebeizhu").val(res.data.xujiebeizhu);
					}
