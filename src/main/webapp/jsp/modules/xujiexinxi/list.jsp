...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">续借信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>续借信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">续借信息列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var xujiebeizhuCell  = document.createElement('td');

						  if(item.xujiebeizhu != null && item.xujiebeizhu != "" && item.xujiebeizhu.length >= 11){
			  	xujiebeizhuCell.innerHTML = item.xujiebeizhu.substring(0, 10) + "..."; 
			  }else{
			  	xujiebeizhuCell.innerHTML = item.xujiebeizhu;
			  }


			row.appendChild(xujiebeizhuCell);
		...
		function sh(){
			...
			httpJson("xujiexinxi/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xujiexinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"xujiexinxi");
