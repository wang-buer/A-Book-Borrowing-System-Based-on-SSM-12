		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑借阅证件</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>借阅证件管理</span></li>
								<li class="breadcrumb-item active"><span>编辑借阅证件</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">借阅证件信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>证件编号</label>
										<input name="zhengjianbianhao" id="zhengjianbianhao" name="zhengjianbianhao" class="form-control" placeholder="证件编号">
									</div>
									<div class="form-group col-md-6">
										<label>个人账号</label>
									...
									<div class="form-group col-md-6">
										<label>可借天数</label>
										<input name="kejietianshu" id="kejietianshu" name="kejietianshu" class="form-control" placeholder="可借天数">
									</div>
									<div class="form-group col-md-6">
										<label>可借数量</label>
										<input name="kejieshuliang" id="kejieshuliang" name="kejieshuliang" class="form-control" placeholder="可借数量">
									</div>
									<div class="form-group col-md-6">
										<label>可续天数</label>
										<input name="kexutianshu" id="kexutianshu" name="kexutianshu" class="form-control" placeholder="可续天数">
									</div>
									<div class="form-group col-md-6">
										<label>备注信息</label>
										<textarea  name="beizhuxinxi" class="form-control" id="beizhuxinxi" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>登记日期</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jieyuezhengjian/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("jieyuezhengjian/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("jieyuezhengjian/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("jieyuezhengjian/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("jieyuezhengjian"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#zhengjianbianhao").val(ruleForm.zhengjianbianhao);	
			...
			$("#kexutianshu").val(ruleForm.kexutianshu);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.zhengjianbianhao != null && res.data.zhengjianbianhao != ''){

						$("#zhengjianbianhao").val(res.data.zhengjianbianhao);
						$("#zhengjianbianhao").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.kejieshuliang != null && res.data.kejieshuliang != ''){
						...
						$("#kejieshuliang").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.kexutianshu != null && res.data.kexutianshu != ''){

						$("#kexutianshu").val(res.data.kexutianshu);
						$("#kexutianshu").attr('readonly','readonly');
					}
